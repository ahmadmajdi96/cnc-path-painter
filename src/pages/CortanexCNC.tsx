...
import { CheckCircle2, Wrench, Zap, BarChart, Shield, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-sky-50/20 to-white">
      ...
      <section className="py-20 bg-gradient-to-r from-sky-600 to-emerald-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Upgrade Your CNC Operations?</h2>
          <p className="text-xl mb-8">
            See how CORTANEX 4.0 CNC Control can transform your machining workflow
          </p>
