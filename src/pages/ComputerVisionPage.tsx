  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="px-6 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Computer Vision</h1>
          <p className="text-muted-foreground">Analyze and process images with AI-powered computer vision models</p>
        </div>
