  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="px-6 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Optical Character Recognition</h1>
          <p className="text-muted-foreground">Extract and digitize text from images and documents with AI-powered OCR</p>
        </div>
